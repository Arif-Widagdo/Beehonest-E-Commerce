...
if (empty($nama_file) && !empty($gambarGedung)) {
	...
	mysqli_query($conn,"UPDATE home_content SET title = '$title',deskripsi_title ='$deskripsi_title',fileGambar='$gambarAsal',gambarGedung='$gambarGedung', span_deskrip='$span_deskrip', btn_nama='$btn_nama' where id='$id' ");
	...
	mysqli_query($conn,"UPDATE home_content SET title = '$title',deskripsi_title ='$deskripsi_title',fileGambar='$nama_file',gambarGedung='$gambarGedungL', span_deskrip='$span_deskrip', btn_nama='$btn_nama'  where id='$id' ");
	header('location:../../kelolaContentHome.php');
	...
	$gambarGedungL=$_POST['gambarGedungL'];
	$gambarAsal=$_POST['gambarAsal'];
	mysqli_query($conn,"UPDATE home_content SET title = '$title',deskripsi_title ='$deskripsi_title',fileGambar='$gambarAsal',gambarGedung='$gambarGedungL', span_deskrip='$span_deskrip', btn_nama='$btn_nama'  where id='$id' ");
	header('location:../../kelolaContentHome.php');
}
