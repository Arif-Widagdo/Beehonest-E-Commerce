...
<body>
	...
	<section class="riwayat-section section" id="contact">
		<div class="container">
			<div class="row">
				<div class="section-title">
					<h2 data-heading="">Riwayat Pembelanjaan</h2>
				</div>
			</div>
			<div class="riwayat-info">
				...
				<div class="table-container">
					<table border="15px" class="tbl-info">
						<thead>
							<tr>
								<th scope="col" class="column-primary" data-header="History List"><span>No</span></th>
						...
						<tbody>
							...
							<tr>
								...
								<td data-header="Tanggal Pembelian"><?= date("d F Y", strtotime($pecah['tanggal_pembelian'])); ?></td>
								<td data-header="Total"><?= $pecah['status_pembelian']; ?><br>
									<?php if(!empty($pecah['resi_pengiriman'])): ?>
									Resi : <?= $pecah['resi_pengiriman']; ?>
									<?php endif; ?></td>
								<td data-header="Total Pembelian">Rp. <?= number_format($pecah['total_pembelian']); ?>,-
								</td>
								<th scope="row">
									<div class="toolbox">
										<?php if($pecah['status_pembelian'] == 'pending'): ?>
											<a href="nota?id=<?= $pecah['id_pembelian']; ?>"
											class="btn btn-info nota"><i class="fas fa-receipt"></i> Nota</a>
										<a href="pembayaran?id=<?= $pecah['id_pembelian']; ?>"
											class="btn btn-success input">Input Pembayaran <i class="fas fa-upload"></i></a>
										<?php else: ?>
										<a href="lihat-pembayaran?id=<?= $pecah['id_pembelian']; ?>"
											class="btn btn-warning lihat"><i class="fas fa-file-invoice"></i> Lihat Pembayaran</a>
										<?php endif; ?>
									</div>
								</th>
							</tr>
