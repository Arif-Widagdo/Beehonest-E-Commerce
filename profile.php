	...
	echo(" assets/img/admin.png");
		...
		echo $info_pelanggan['gambar_profile']; ?>" class="outer-shadow"
            ...
            <div class="row button-setting-acount">
              ...
              <a  class="btn-1 active outer-shadow "><i class="fas fa-user-alt"></i> Profile</a>
              </div>
              <div class="button-item ">
              <a href="editprofile" class="btn-1 outer-shadow hover-in-shadow"><i class="fas fa-user-edit"></i> Edit Profile</a>
              </div>
              <div class="button-item ">
          ...
          <div class="profile-text">
              ...
              <div class="input-group-textarea outer-shadow ">
             <textarea class="input-control-bio" readonly type="text" name="alamat_pengiriman" class="form-control">
                 
             <?php 

                if (!$info_pelanggan['bio']){
                    echo("Masukan Bio Data Anda di menu edit profile");
                }else
                         echo $info_pelanggan['bio']; ?></textarea>
              </div>
             <label for="" style="margin-left:15px">Nama Lengkap</label>
             <div class="input-group outer-shadow ">
             <input class="input-control" type="text" readonly value="<?php echo $info_pelanggan['nama_pelanggan']; ?>" class="form-control">
              </div>
              <label for="" style="margin-left:15px">Email</label>
              <div class="input-group outer-shadow ">
                <input class="input-control" type="text" readonly value="<?php echo $info_pelanggan['email_pelanggan']; ?>" class="form-control">
              </div>
              <label for="" style="margin-left:15px">Nomor Telepon</label>
              <div class="input-group outer-shadow ">
                <input class="input-control" type="text" readonly value="<?php echo $info_pelanggan['telepon_pelanggan']; ?>" class="form-control">
              </div>
              <label for="" style="margin-left:15px">Alamat</label>
              <div class="input-group-textarea outer-shadow ">
             <textarea class="input-control-alamat" readonly type="text" name="alamat_pengiriman" class="form-control"><?php echo $info_pelanggan['alamat_pelanggan']; ?></textarea>
              </div>
